...
Template.output5.helpers({
 ...
 start: function (){
        ...
        var start=moment(start).add(4,'days').format("YYYY-MM-DD 00:00:00.000")
         var end=Queries.find().fetch().pop().endtime
         var end=moment(end).add(4,'days').format("YYYY-MM-DD 24:59:99.999")
var end=moment(end).format("YYYY-MM-DD 24:59:99.999")
       ...
       var startnew=moment(timestamp).add(4,'days').format("YYYY-MM-DD 07:00:00.000")
        ...
        var start=moment(start).format("YYYY-MM-DD 00:00:00.000")
         var end=Queries.find().fetch().pop().endtime
             var end=moment(end).format("YYYY-MM-DD 24:59:99.999")
              ...
              var ehour= '1'
        var timestamp=Parts.findOne({timestamp: {$gt: start,$lt: end}, workcenter:wc}).timestamp 
        timestamp = moment(timestamp).add(4,'days').format("YYYY-MM-DD 07:00:00.000")
       ...
       var workcenter=Queries.find().fetch().pop().workcenter      
        ...
        var start=moment(start).format("YYYY-MM-DD 00:00:00.000")
         var end=Queries.find().fetch().pop().endtime
            ...
            //count should go from the start of the query to the end of the hour of the day the job was submitted.
             var end=Parts.find({timestamp: {$gt: start,$lt: end}, workcenter:wc},{sort: {timestamp: 1}, limit: 1}).fetch().pop().timestamp
              var end=moment(end).add(5, 'days').format("YYYY-MM-DD 01:00:00.000")
             var count= Parts.find({timestamp: {$gt: start,$lt: end}, workcenter:wc}).count()
       var workcenter=Queries.find().fetch().pop().workcenter      
          var ehour= '18'
             var timestamp=Parts.findOne({timestamp: {$gt: start,$lt: end}, workcenter:wc}).timestamp  
        ...
        var start=moment(start).format("YYYY-MM-DD 00:00:00.000")
         var end=Queries.find().fetch().pop().endtime
            ...
            //count should go from the start of the query to the end of the hour of the day the job was submitted.
             var end=Parts.find({timestamp: {$gt: start,$lt: end}, workcenter:wc},{sort: {timestamp: 1}, limit: 1}).fetch().pop().timestamp
              var end=moment(end).add(5, 'days').format("YYYY-MM-DD 02:00:00.000")
             var count= Parts.find({timestamp: {$gt: start,$lt: end}, workcenter:wc}).count()
       var workcenter=Queries.find().fetch().pop().workcenter      
          var ehour= '19'
             var timestamp=Parts.findOne({timestamp: {$gt: start,$lt: end}, workcenter:wc}).timestamp 
        ...
        var start=moment(start).format("YYYY-MM-DD 00:00:00.000")
         var end=Queries.find().fetch().pop().endtime
            ...
            //count should go from the start of the query to the end of the hour of the day the job was submitted.
             var end=Parts.find({timestamp: {$gt: start,$lt: end}, workcenter:wc},{sort: {timestamp: 1}, limit: 1}).fetch().pop().timestamp
              var end=moment(end).add(5, 'days').format("YYYY-MM-DD 03:00:00.000")
             var count= Parts.find({timestamp: {$gt: start,$lt: end}, workcenter:wc}).count()
       var workcenter=Queries.find().fetch().pop().workcenter      
          var ehour= '20'
             var timestamp=Parts.findOne({timestamp: {$gt: start,$lt: end}, workcenter:wc}).timestamp 
        ...
        var start=moment(start).format("YYYY-MM-DD 00:00:00.000")
         var end=Queries.find().fetch().pop().endtime
            ...
            //count should go from the start of the query to the end of the hour of the day the job was submitted.
             var end=Parts.find({timestamp: {$gt: start,$lt: end}, workcenter:wc},{sort: {timestamp: 1}, limit: 1}).fetch().pop().timestamp
              var end=moment(end).add(5, 'days').format("YYYY-MM-DD 04:00:00.000")
             var count= Parts.find({timestamp: {$gt: start,$lt: end}, workcenter:wc}).count()
       var workcenter=Queries.find().fetch().pop().workcenter      
          var ehour= '21'
             var timestamp=Parts.findOne({timestamp: {$gt: start,$lt: end}, workcenter:wc}).timestamp  
        ...
        var start=moment(start).format("YYYY-MM-DD 00:00:00.000")
         var end=Queries.find().fetch().pop().endtime
            ...
            //count should go from the start of the query to the end of the hour of the day the job was submitted.
             var end=Parts.find({timestamp: {$gt: start,$lt: end}, workcenter:wc},{sort: {timestamp: 1}, limit: 1}).fetch().pop().timestamp
              var end=moment(end).add(5, 'days').format("YYYY-MM-DD 05:00:00.000")
             var count= Parts.find({timestamp: {$gt: start,$lt: end}, workcenter:wc}).count()
       var workcenter=Queries.find().fetch().pop().workcenter      
          var ehour= '22'
             var timestamp=Parts.findOne({timestamp: {$gt: start,$lt: end}, workcenter:wc}).timestamp 
        ...
        var start=moment(start).format("YYYY-MM-DD 00:00:00.000")
         var end=Queries.find().fetch().pop().endtime
            ...
            //count should go from the start of the query to the end of the hour of the day the job was submitted.
             var end=Parts.find({timestamp: {$gt: start,$lt: end}, workcenter:wc},{sort: {timestamp: 1}, limit: 1}).fetch().pop().timestamp
              var end=moment(end).add(5, 'days').format("YYYY-MM-DD 06:00:00.000")
             var count= Parts.find({timestamp: {$gt: start,$lt: end}, workcenter:wc}).count()
       var workcenter=Queries.find().fetch().pop().workcenter      
          var ehour= '23'
             var timestamp=Parts.findOne({timestamp: {$gt: start,$lt: end}, workcenter:wc}).timestamp  
        ...
        var start=moment(start).format("YYYY-MM-DD 00:00:00.000")
         var end=Queries.find().fetch().pop().endtime
            ...
            //count should go from the start of the query to the end of the hour of the day the job was submitted.
             var end=Parts.find({timestamp: {$gt: start,$lt: end}, workcenter:wc},{sort: {timestamp: 1}, limit: 1}).fetch().pop().timestamp
              var end=moment(end).add(5, 'days').format("YYYY-MM-DD 07:00:00.000")
             var count= Parts.find({timestamp: {$gt: start,$lt: end}, workcenter:wc}).count()
       var workcenter=Queries.find().fetch().pop().workcenter      
          var ehour= '24'
             var timestamp=Parts.findOne({timestamp: {$gt: start,$lt: end}, workcenter:wc}).timestamp  
