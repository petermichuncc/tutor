Template.output7.rendered =function(){
...
Template.output7.helpers({
 ...
 start1: function (){
        ...
        var start=moment(start).add(6,'days').format("YYYY-MM-DD 07:00:00.000")
         var end=Queries.find().fetch().pop().endtime
         var end=moment(end).add(6,'days').format("YYYY-MM-DD 08:00:00.000")
 ...
 finish1: function (){
        ...
        var end=Queries.find().fetch().pop().endtime
         ...
         var timestamp=Hours.find({timestamp: {$gt: start,$lt: end}, workcenter:wc}).fetch().pop().timestamp
           timestamp= moment(timestamp).format("YYYY-MM-DD HH:mm")
          return timestamp
...
planned1: function (){
        ...
        var ehour= '1'
        var start=moment(start).add(6,'days').format("YYYY-MM-DD 00:00:00.000")
